...
OUTPUT_ROOT="$SHARED_REPO/outputs/agent/graph_electron_dual_import_full_batched_8a100_20260920"
...
print({'runtime_gate':'passed','gpus':names,'rdkit':rdkit.__version__,
       ...
       'environment_bank':m['environment_fragment_bank']['unique']},flush=True)
PY

echo "[graph-batched] starting packed-graph 8-GPU training"
