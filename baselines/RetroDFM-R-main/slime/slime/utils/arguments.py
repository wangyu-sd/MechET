    ...
    def add_slime_arguments(parser):
        ...
        def add_algo_arguments(parser):
            ...
            parser.add_argument(
                ...
                action="store_true",
                default=False,
                help="Skip Megatron checkpoint saving and only write --save-hf outputs at save intervals.",
            )
...
def slime_validate_args(args):
    ...
    if args.save_interval is not None:
        if args.save_hf_only:
            assert args.save_hf is not None, "'--save-hf' is required when save_hf_only is set."
        else:
